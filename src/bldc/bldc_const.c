...
/*
*/
#define BLDC_COMPARATOR_IS_EXTERNAL_STARTUP 0
const uint32_t BLDC_COMPARATOR_SETUP_TABLE[2][6] = {
	{ // CW
		...
		AC_COMPCTRL_SINGLE (BLDC_COMPARATOR_IS_EXTERNAL_STARTUP) |
		...
		AC_COMPCTRL_SPEED_HIGH |
		AC_COMPCTRL_SWAP (0) |
		AC_COMPCTRL_MUXPOS_PIN1 | // BEMF-B (PA05)
		AC_COMPCTRL_MUXNEG_PIN3 | // NEUTRO (PA07)
		AC_COMPCTRL_RUNSTDBY (0) |
		...
		AC_COMPCTRL_SPEED_HIGH |
		AC_COMPCTRL_SWAP (0) |
		AC_COMPCTRL_MUXPOS_PIN2 | // BEMF-A (PA06)
		AC_COMPCTRL_MUXNEG_PIN3 | // NEUTRO (PA07)
		AC_COMPCTRL_RUNSTDBY (0) |
		AC_COMPCTRL_INTSEL_FALLING |
		AC_COMPCTRL_SINGLE (BLDC_COMPARATOR_IS_EXTERNAL_STARTUP) |
