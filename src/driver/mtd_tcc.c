...
static void init_tcc1 () {
	...
	TCC1_REGS->TCC_PER = TCC_PER_PER (TCC1_PERIOD);
	TCC1_REGS->TCC_PERBUF = TCC_PERBUF_PERBUF (TCC1_PERIOD);
	TCC1_REGS->TCC_CC[0] = TCC_CC_CC (0); // high-side
	TCC1_REGS->TCC_CC[1] = TCC_CC_CC (0); // low-side
